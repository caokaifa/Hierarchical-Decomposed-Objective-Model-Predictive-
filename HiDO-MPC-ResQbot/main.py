...
import sys
import os
sys.path.append(os.path.abspath('/home/robert/catkin_ws/src/HiDO-MPC-ResQbot/corridor_experiments'))
...
EXP_SETUP ={'1':[np.array([-10, -10, np.deg2rad(0)]),np.array([3.2, 0.0, 3.7, 0.0])], 
...
if __name__ == '__main__':
    ...
    for M in M_list:
        for S in S_list:
            ...
            print("s88=",S)
            t,xx,xx1,u_cl,xs,c1,dist2point_his, dist2line_his, angle_diff_his, mpc_proc_time_his = HIDO.main(V0, C0, T, N)
            # print("5777777777777776=",u_cl)
